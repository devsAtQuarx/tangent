...
exports[`VSelect.js should render buttons correctly when using items array with segmented prop 1`] = `
...
exports[`VSelect.js should render buttons correctly when using slot with segmented prop 1`] = `
