...
<script>
    export default {
        ...
        methods:{
            ...
            goToShowStudentAccount(){
                this.goWhere = 'student'
                this.goToShowAccounts()
            },
            ...
            goToCreateTeacherAccount(){
                this.goWhere = 'teacher'
                this.goToCreateAccount()
            },
            goToShowTeacherAccount(){
                this.goWhere = 'teacher'
                this.goToShowAccounts()
            },

            //goTo show/create account
            goToCreateAccount(){
                this.$router.push({
                    name: 'createAccount',
                    params:{
